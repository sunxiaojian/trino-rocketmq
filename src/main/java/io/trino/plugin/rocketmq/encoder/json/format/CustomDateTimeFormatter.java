...
import static io.trino.plugin.rocketmq.encoder.json.format.util.TimeConversions.PICOSECONDS_PER_SECOND;
import static io.trino.plugin.rocketmq.encoder.json.format.util.TimeConversions.getMillisOfDay;
import static io.trino.plugin.rocketmq.encoder.json.format.util.TimeConversions.scaleEpochMicrosToMillis;
