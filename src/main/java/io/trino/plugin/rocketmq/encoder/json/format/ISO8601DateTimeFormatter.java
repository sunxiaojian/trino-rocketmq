...
import static io.trino.plugin.rocketmq.encoder.json.format.util.TimeConversions.NANOSECONDS_PER_MICROSECOND;
import static io.trino.plugin.rocketmq.encoder.json.format.util.TimeConversions.NANOSECONDS_PER_MILLISECOND;
import static io.trino.plugin.rocketmq.encoder.json.format.util.TimeConversions.getMicrosOfSecond;
import static io.trino.plugin.rocketmq.encoder.json.format.util.TimeConversions.getMillisOfSecond;
import static io.trino.plugin.rocketmq.encoder.json.format.util.TimeConversions.getNanosOfDay;
import static io.trino.plugin.rocketmq.encoder.json.format.util.TimeConversions.scaleEpochMicrosToSeconds;
import static io.trino.plugin.rocketmq.encoder.json.format.util.TimeConversions.scaleEpochMillisToSeconds;
import static io.trino.plugin.rocketmq.encoder.json.format.util.TimeConversions.scalePicosToMillis;
import static io.trino.plugin.rocketmq.encoder.json.format.util.TimeConversions.scalePicosToNanos;
