 ...
 */
package io.trino.plugin.rocketmq.encoder.json;
...
import io.trino.plugin.rocketmq.encoder.AbstractRowEncoder;
import io.trino.plugin.rocketmq.encoder.EncoderColumnHandle;
import io.trino.plugin.rocketmq.encoder.json.format.DateTimeFormat;
import io.trino.plugin.rocketmq.encoder.json.format.JsonDateTimeFormatter;
import io.trino.plugin.rocketmq.encoder.json.format.UnimplementedJsonDateTimeFormatter;
...
public class JsonRowEncoder
    ...
    private static DateTimeFormat parseDataFormat(String dataFormat, String columnName) {
        try {
            return DateTimeFormat.valueOf(dataFormat.toUpperCase(ENGLISH).replaceAll("-", "_"));
